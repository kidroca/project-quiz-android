...
import com.example.kidroca.mylittlequizapp.main.MainActivity;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    private List<NavLink> navLinks = Collections.emptyList();
    ...
    @InjectView(R.id.navigationListDrawer)
    RecyclerView mRecyclerDrawer;

    private boolean mUserLearnedDrawer;
    private boolean mFromSavedInstanceState;
    private List<NavLink> data;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUserLearnedDrawer = Boolean.valueOf(
                QuizApplication.readFromPreference(getActivity(), KEY_USER_LEARNED_DRAWER, "false"));
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new AdapterNavigation(getActivity(), getData());
        mRecyclerDrawer.setAdapter(mAdapter);
        mRecyclerDrawer.setLayoutManager(new LinearLayoutManager(getActivity()));

        mRecyclerDrawer.addOnItemTouchListener(new RecyclerTouchListener(
                getActivity(), mRecyclerDrawer, new RecyclerTouchListener.ClickListener() {

            @Override
            public void onClick(View view, int position) {
                mDrawerLayout.closeDrawer(GravityCompat.START);
                int index = position - 1;
                ((MainActivity) getActivity()).onDrawerItemClicked(index, getData().get(index));
            }
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                if (!mUserLearnedDrawer) {
                    ...
                    QuizApplication.saveToPreferences(getActivity(), KEY_USER_LEARNED_DRAWER, mUserLearnedDrawer + "");
                }
    ...
    public List<NavLink> getData() {
        ...
        if (navLinks.isEmpty()) {
            ...
            String[] titles = getResources().getStringArray(R.array.link_titles);
            String[] hrefs = getResources().getStringArray(R.array.link_hrefs);

            for (int i = 0; i < titles.length; i++) {
                NavLink link = new NavLink(icons[i], titles[i], hrefs[i]);
                navLinks.add(link);
            }
        }
